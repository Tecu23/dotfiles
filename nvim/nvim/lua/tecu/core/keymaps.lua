...
keymap("n", "<A-t>", ':lua require("nvterm.terminal").toggle "float"<CR>', opts)
keymap("t", "<A-t>", '<C-\\><C-n><cmd>lua require("nvterm.terminal").toggle "float"<CR>', opts)
keymap("n", "<A-h>", ':lua require("nvterm.terminal").toggle "horizontal"<CR>', opts)
keymap("t", "<A-h>", '<C-\\><C-n><cmd>lua require("nvterm.terminal").toggle "horizontal"<CR>', opts)
keymap("n", "<A-H>", ':lua require("nvterm.terminal").toggle "vertical"<CR>', opts)
keymap("t", "<A-H>", '<C-\\><C-n><cmd>lua require("nvterm.terminal").toggle "vertical"<CR>', opts)
